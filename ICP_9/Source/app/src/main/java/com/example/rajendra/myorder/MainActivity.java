package com.example.rajendra.myorder;
...
// below is the main logic to send the email to customer email
    public void sendEmail(View view) {
        Intent intent = new Intent(Intent.ACTION_SEND);
        intent.setType("text/plain");
        intent.putExtra(Intent.EXTRA_EMAIL, new String[]{"rajendraganji2019@gmail.com"});
